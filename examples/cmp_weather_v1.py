...
if input("Would you like to view error states for weather-1? (y/n)") == "y":
    errored_info = analysis.analyze_errored(weather_1_states)
...
if input("Would you like to view error states for weather-2? (y/n)") == "y":
    errored_info = analysis.analyze_errored(weather_2_states)
    print(analysis.report_errored_states(errored_info, args, concrete_arg_mapper=concrete_mapper, num_examples=2))
...
if input("Would you like to view error states for weather-3? (y/n)") == "y":
    errored_info = analysis.analyze_errored(weather_3_states)
    print(analysis.report_errored_states(errored_info, args, concrete_arg_mapper=concrete_mapper, num_examples=2))
...
if input("Would you like to compare weather-1 and weather-2? (y/n)") == "y":
    ...
    comparison_results = analysis.compare_states(weather_1_states, weather_2_states, weather_1_addrs + weather_2_addrs, compare_std_out=True, compare_memory=mem_reg_diff, compare_registers=mem_reg_diff, use_memoized_binary_search=False)
...
if input("Would you like to compare weather-2 and weather-3? (y/n)") == "y":
    ...
    comparison_results = analysis.compare_states(weather_2_states, weather_3_states, weather_2_addrs + weather_3_addrs, compare_std_out=True, compare_memory=mem_reg_diff, compare_registers=mem_reg_diff, use_memoized_binary_search=False)
    print(comparison_results.report(args, concrete_arg_mapper=concrete_mapper))

if input("Would you like to compare weather-1 and weather-3? (y/n)") == "y":
    print("\n\nCOMPARING WEATHER-1 and WEATHER-3")
    comparison_results = analysis.compare_states(weather_1_states, weather_3_states, weather_1_addrs + weather_3_addrs, compare_std_out=True, compare_memory=mem_reg_diff, compare_registers=mem_reg_diff, use_memoized_binary_search=False)
    print(comparison_results.report(args, concrete_arg_mapper=concrete_mapper))
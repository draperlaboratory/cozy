...
second_prog = 'test_programs/injection_demo/injectionAttack-badPatch-patcherex'
use_concolic = "n"
...
cozy.execution_graph.dump_comparison(proj_prepatched, proj_postpatched,
                                     ...
                                     comparison, "injectionAttack", "injectionAttack_badPatch",
                                     "cozy-result_injection_bad-patch.json",

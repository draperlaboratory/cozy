...
amp_hackathon_path = os.path.expanduser("~/Projects/VIBES/Hackathon_Spring_24/MRZR")
...
proj_postpatched = cozy.project.Project(f"{amp_hackathon_path}/operator_patches/classroom_MRZR_sysinfo/repro_goodandbad_patches/withfailcheck.bin")
...
proj_postpatched.hook_symbol("_ZNSt9basic_iosIcSt11char_traitsIcEE4initEPSt15basic_streambufIcS1_E", sysinfo_hook)
...
args = {"size": size, "totalram": totalram, "freeram": freeram, "sysinfo_freemram": freeram_garbage,
...
cozy.execution_graph.dump_comparison(proj_prepatched, proj_postpatched,
                                     ...
                                     comparison_results,
                                     "libroscpp.so", "withoutfailcheck.bin",
                                     "cozy-result_mrzr_with_fail_check.json",

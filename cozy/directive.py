...
class Assert(Directive):
    """
    An assert directive sets a breakpoint at a certain offset from a function start. An assert is triggered if there is a concrete input which would cause the assertion condition to be satisfied.
    ...
    """
    def __init__(self, project: Project, fun_name: str, offset: int, condition_fun: Callable[[SimState], claripy.ast.bool], info_str: str | None=None):
        """
        Constructor for an Assert object.

        :param Project project: The project which this assert is attached to. The project is used to compute the address of the assert.
...
class Assume(Directive):
    """
    An assume directive sets a breakpoint at a certain offset from a function start. An assume simply adds an extra constraint to the state's accumulated constraints before resuming execution. An assume is useful for adding a precondition.
    ...
    def __init__(self, project: Project, fun_name: str, offset: int, condition_fun: Callable[[SimState], claripy.ast.bool], info_str: str | None=None):
        ...
        :param Project project: The project this assume is attached to.
...
class VirtualPrint(Directive):
    ...
    """
    def __init__(self, project: Project, fun_name: str, offset: int, log_fun: Callable[[SimState], claripy.ast.Base], concrete_mapper: Callable[[claripy.ast.Base], any] | None=None, info_str: str="Unknown Virtual Print: "):
        """
        Constructor for a VirtualPrint object.

        :param Project project: The project which this virtual print is attached to. The project is used to compute the address of the virtual print.
...
class ErrorDirective(Directive):
    ...
    :ivar str | None info_str: Human readable information for this error directive.
    """
    def __init__(self, project: Project, fun_name: str, offset: int, info_str: str | None=None):
        """
        Constructor for an ErrorDirective object.

        :param Project project: The project this error directive should be attached to.
